...
function PageHeader({
  ...
  return (
    <section className="page-reveal glass-panel relative overflow-hidden rounded-[36px] border border-white/75 p-5 shadow-[0_28px_80px_-40px_rgba(15,23,42,0.48)] sm:p-6">
      ...
      <div className="relative flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex w-full flex-col items-start gap-4 xl:w-auto xl:items-end">
          ...
          {action ? (
            <div className="relative w-full max-w-full xl:w-auto [&>*]:w-full sm:[&>*]:w-auto">
              {action}
            </div>
          ) : null}
        </div>
