...
function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex justify-end bg-slate-950/45 backdrop-blur-sm">
      ...
      <aside className="page-reveal relative z-10 flex h-full w-full max-w-[460px] flex-col border-l border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(248,250,252,0.98)_100%)] shadow-[-24px_0_80px_-36px_rgba(15,23,42,0.55)]">
