...
function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex justify-end bg-slate-950/45 backdrop-blur-sm">
      ...
      <aside className="page-reveal relative z-10 h-full w-full max-w-[460px] overflow-y-auto overscroll-contain border-l border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.97)_0%,rgba(248,250,252,0.98)_100%)] shadow-[-24px_0_80px_-36px_rgba(15,23,42,0.55)] touch-pan-y">
        <div className="flex min-h-full flex-col">
          <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(248,250,252,0.98)_100%)] px-5 py-5 backdrop-blur">
            <div>
            ...
            <button
              type="button"
              onClick={handleClose}
              className="rounded-2xl border border-slate-200 bg-white p-2.5 text-slate-600 transition hover:bg-slate-100"
                ...
                {cartItems.map((cartItem) => {
                  ...
                  return (
                    <article
                      ...
                      className="rounded-[28px] border border-slate-200/80 bg-white/90 p-4 shadow-[0_18px_50px_-34px_rgba(15,23,42,0.3)]"
                    >
                          ...
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                              ...
                              <Link
                                ...
                                onClick={handleClose}
                                className="mt-1 block truncate text-sm font-semibold text-slate-950 transition hover:text-sky-700"
                              >
