...
const toneClasses: Record<ChromeButtonTone, string> = {
  dark:
    'border border-slate-700 bg-white/5 text-slate-300 hover:border-slate-500 hover:text-white',
  light:
    'border border-white/70 bg-white/[0.78] text-slate-700 shadow-[0_12px_32px_-22px_rgba(15,23,42,0.4)] hover:bg-slate-100',
}
