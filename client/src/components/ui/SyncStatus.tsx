...
function SyncStatus({
  ...
  return (
    <div className="rounded-[28px] border border-slate-200/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.94)_0%,rgba(236,253,245,0.96)_100%)] p-5 shadow-[0_18px_50px_-32px_rgba(15,23,42,0.45)]">
